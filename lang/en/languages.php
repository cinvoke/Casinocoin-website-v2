...
DEFINE("HEADER_NAV_2", "Users");
DEFINE("HEADER_NAV_3", "Miners");
DEFINE("HEADER_NAV_4", "Developers");
DEFINE("HEADER_NAV_5", "Code Examples");
...
DEFINE("HEADER_NAV_15", "Responsible Gambling");
...
DEFINE("HOME_SLIDER_1_LANG", "Take Control of Your Online Presence");
DEFINE("HOME_SLIDER_11_LANG", "Casinocoin is a fast, cost-efficient, secure way to keep your funds secure online by harnessing blockchain technology.");

DEFINE("HOME_SLIDER_2_LANG", "Accessibility, Exchangeability");
DEFINE("HOME_SLIDER_22_LANG", "You can use your Casinocoin anywhere Casinocoin is accepted, but you can transfer Casinocoin to anyone, anyhere to their unique address without going through third party institutions.");

DEFINE("HOME_SLIDER_3_LANG", "Strong Community");
DEFINE("HOME_SLIDER_33_LANG", "Casinocoin is backed by a community of like-minded individuals and organizations who believe in its success. We share our ideas, and progress as a team.");

DEFINE("HOME_VIDEO_CAPTION_LANG", "Casinocoin is kind of like bitcoin");
DEFINE("HOME_BLOCK_1_LANG", "LETS GET STARTED");

DEFINE("HOME_TEXT_1_LANG", "Casinocoin Revolutionizing Online Gambling and Payments");
DEFINE("HOME_TEXT_2_LANG_1", "Download Your Wallet Now");
DEFINE("HOME_TEXT_2_LANG", "Choose Your Platform");
DEFINE("HOME_TEXT_3_LANG", "Wallet Version 2.0.1.0 as of 12/28/2015");



DEFINE("HOME_STAY_CONN", "Stay Connected");
DEFINE("HOME_STAY_CONN_TEXT", "Manage, Store, Send, and Recieve Casinocoin Anywhere with your Wallet.");
DEFINE("HOME_STAY_CONN1", "Purchase or Mine");
DEFINE("HOME_STAY_CONN_TEXT1", "You can <a href='/casinocoin-for-users'>Purchase</a> Casinocoin from an exchange or <a href='/casinocoin-for-miners'>Mine</a> for it!");
DEFINE("HOME_STAY_CONN2", "Easy to Accept");
...
DEFINE("HOME_LR_TEXT1", "Secure Network<br />Open Market");
DEFINE("HOME_LR_TEXT_PAR1", "Casinocoin's security relies in the strength of the network and miners while the market relies on the supply and demand from users.");
DEFINE("HOME_VIEW_RES_BUT", "View all Resources");
DEFINE("HOME_SLIDER_TEXT1", "Peace of Mind");
DEFINE("HOME_SLIDER_TEXT11", "Take Control of Your Online Presence");
DEFINE("HOME_SLIDER_TEXT2", "Accessibility");
DEFINE("HOME_SLIDER_TEXT22", "Free for Anyone, Anywhere");
DEFINE("HOME_SLIDER_TEXT3", "Strong Community");
DEFINE("HOME_SLIDER_TEXT33", "We are Passionate about Casinocoin");
DEFINE("HOME_PROUD_LANG", "SUPPORTED BY");
...
DEFINE("CASINOCOIN_GETTING_STARTED", "Getting Started with Casinocoin");
DEFINE("CASINOCOIN_MERCHANTS_LIST", "Casinocoin Merchants and Services");
DEFINE("CASINOCOIN_RESOURCES_LIST", "A full list of Casinocoin Resources");
DEFINE("CASINOCOIN_RES_GAMBLING", "Responsible Gambling Information Websites");
DEFINE("CASINOCOIN_PRESS", "Casinocoin Press Kit");
...
DEFINE("CASINOCOIN_FAQ_A1", "You may be running on an old version of the wallet please check your current version is up-to-date or Try adding casinocoin.conf file to your AppDate. Example is <a href='/code-examples'>here</a>");
...
DEFINE("CASINOCOIN_GS_SUPPORTING", "Everything you'll need to know to get started.");


DEFINE("GS_STATEMENT_LANG", "Dubbed as 'Black Friday' by the online gambling community resulted in many online poker and gambling sites refusing players from various countries. Casinocoin is here to fill that void, and give the right to gamble back to the people. Every Casinocoin is Easily exchangeable between peers, exchanges, gaming platforms, and more. This gives the user a huge advantage over choice and exchangeability. Casinocoin in essence is a universal Casino chip accessible by anyone, anywhere with an internet connection");
DEFINE("EASY_TO_USE_LANG", "EASY TO USE");
DEFINE("GS_TEXT_1_LANG", "Downloading your first Casinocoin wallet should be a seamless process, we are working hard to ensure everybody can use and understand Casinocoin without the burden advanced technology can place on the end user. If you have any questions check the faqs page or email us");
...
DEFINE("GS_TEXT_2_LANG", "Casinocoin is revoloutionary software that stores transaction history on a block chain. Casinocoin extends the Bitcoin codebase and stores additional information on a seperate network. Building applications for Casinocoin in a multitude of languages is easy with our API documentation");
DEFINE("GS_TEXT_3_LANG", "A good time to note that Casinocoin is sometimes abbreviated as CsC");
DEFINE("GS_TEXT_4_LANG", "Getting Your First CsC");
DEFINE("GS_TEXT_5_LANG", "Read more about Casinocoin");
DEFINE("GS_TEXT_6_LANG", "Using Casinocoin may be very different for some users, and while we want everyone to use Casinocoin we also want everyone to be informed and take the neccessary precautions to protect their security.");
DEFINE("GS_TEXT_7_LANG", "Choose your platform, download a wallet");
DEFINE("GS_TEXT_8_LANG", "Casinocoin is striving to be available on every single device, but may not yet be on yours of choice. Take a look at the downloads page under the resources tab for available wallets. ");
DEFINE("GS_TEXT_9_LANG", "Recieve your first Casinocoins");
DEFINE("GS_TEXT_10_LANG", "There is several ways to obtain Casinocoin. The most popular methods of acquiring Casinocoin right now are mining, recieving CsC as payment, or purchasing CsC on an exchange.");
DEFINE("GS_TEXT_11_LANG", "Casinocoin is growing every single day, more and more merchants, exchanges, businesses, and gambling websites are starting to accept Casinocoin. You can also send Csc to friends or family.");
DEFINE("GS_TEXT_12_LANG", "Casinocoin as a Merchant");
DEFINE("GS_TEXT_13_LANG", "Getting Informed as a CsC Merchant");
DEFINE("GS_TEXT_14_LANG", "Using Casinocoin may be very different for some merchants, accepting and integrating the CsC wallet into your existing platform can be simple but by informing yourself you ensure the security of your funds and your users.");
DEFINE("GS_TEXT_15_LANG", "Setting up Your Wallet");
DEFINE("GS_TEXT_16_LANG", "There is currently n oexisting POS systems avaiable for Casinocoin but we look forward to the future where there will be one. In the meantime you may setup and build ontop Casinocoin-d wallet that is a great starting point.");
DEFINE("GS_TEXT_17_LANG", "Ensuring you and your users are compliant");
DEFINE("GS_TEXT_18_LANG", "Ensure you and your users are complying with all state and federal laws in your jurisdiction. By becoming informed it will help you decide who and who not to accept or send Casinocoin to.");
DEFINE("GS_TEXT_19_LANG", "The Casinocoin Community");
DEFINE("GS_TEXT_20_LANG", "The Casinocoin community is a great place to show off your new app, website, service or even idea. You may apply to become apart of the Casinocoin merchants list through the contact form or our bitcointalk thread.");

/*** CASINOCOIN RESOURCES ***/

DEFINE("RESOURCES_LIST_HEADER_SUPPORT", "Don't see your service or resource listed? Let us know!");

/*** CASINOCOIN MERCHANTS ***/

DEFINE("MERCHANTS_LIST_HEADER_SUPPORT", "Want to get listed? Contact merchants@casinocoin.org");

/*** RESPONSIBLE GAMBLING ***/

DEFINE("RESGAMBLING_LIST_HEADER_SUPPORT", "Responsible gambling is safe gambling, it is ok to seek help.");

/*** PRESS KIT ***/

DEFINE("PRESS_LIST_HEADER_SUPPORT", "All images released under the mit license.");
